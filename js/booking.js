      ...
      <div class="booking-popup">
        ...
        <div class="booking-container">
          ...
          <div class="booking-buttons">
            <a href="" class="booking-button booking-button-active" name="Date"><svg width="14" height="16"
                viewBox="0 0 14 16" class="booking-svg booking-button-active" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <a href="" class="booking-button" name="Time"><svg width="16" height="16" viewBox="0 0 16 16"
                class="booking-svg" xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              Time</a>
            <a href="" class="booking-button" name="Guests">
              <svg width="16" height="16" viewBox="0 0 16 16" class="booking-svg" xmlns="http://www.w3.org/2000/svg">
                <path
